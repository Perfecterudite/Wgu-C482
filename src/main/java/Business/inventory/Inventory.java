...
public class Inventory {
    ...
    /**
     * Adds new parts to the allParts observable list.
     * @param newPart
     */
    ...
    /**
     * Adds new products to the allProducts observable list.
     * @param newProduct
     */
    ...
    /**
     * For loop to check parts and return if found by iterating.
     * @param partID
     ...
     * Iterate through a
     * @param productID
     * @return product if found and null if no item found.
     */
